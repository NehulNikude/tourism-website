...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Initialize Firebase with compat version (as imported in HTML)
  ...
  const authModal = $('#authModal'); // jQuery reference for Bootstrap modal
...
// Existing code for the website functionality
